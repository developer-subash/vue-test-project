...
import WithRender from '@/Pages/Admin/Modules/ManageDeparture/Views/edit-departure.html';
...
export default class EditDeparture extends Vue {
  protected ui: any = {};
 ...
 public departurePrice() {
    ...
    trekService
      ...
      .then((res: any) => {
        ...
        if (res.data.data.price) {
          ...
          this.Departure.Price = res.data.data.trek.base_price;
        }
        ...
        // let abc = res.data.data.trek.trek_pricing_rules[0];
        // let abc = res.data.data.trek.base_price;
  ...
  public enableEditMode() {
    ...
    this.EditPrice.Price = this.Departure.Price;
  }
  ...
  protected SaveDeparture() {
    ...
    this.errorsSave = {};
    let has_departure = 0;
    if (this.EditPrice.Price === this.Departure.Price) {
      has_departure = 0;
      console.log("IF", has_departure);
    } else {
      has_departure = 1;
      console.log("ELSE", has_departure);
    ...
    let data = {
      ...
      has_departure_price: Number(has_departure),
    };
    // console.log(payLoad);
